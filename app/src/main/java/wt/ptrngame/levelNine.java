...
public class levelNine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level_nine_completed = preferences3.getInt("LevelNineCompleted", 0);
        ...
        level_nine_starred = preferences4.getInt("LevelNineStarred", 0);
    ...
    public void levelWon(){
        ...
        if(level_nine_completed == 0){
            level_nine_completed = 1;
            total_completed += 1;
        }
        else{
            level_nine_completed = 1;
        ...
        if(current_toggles <= toggles_for_star){
            if(level_nine_starred == 0){
                level_nine_starred = 1;
                total_starred += 1;
                if(sounds_toggle == 0){
        ...
        editor5.putInt("LevelNineStarred", level_nine_starred);
        editor5.apply();
