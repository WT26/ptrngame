...
public class levelThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level_three_completed = preferences3.getInt("LevelThreeCompleted", 0);
        ...
        level_three_starred = preferences4.getInt("LevelThreeStarred", 0);
    ...
    public void levelWon(){
        ...
        if(level_three_completed == 0){
            level_three_completed = 1;
            total_completed += 1;
        }
        else{
            level_three_completed = 1;
        ...
        if(current_toggles <= toggles_for_star){
            if(level_three_starred == 0){
                level_three_starred = 1;
                total_starred += 1;
                if(sounds_toggle == 0){
        ...
        editor5.putInt("LevelThreeStarred", level_three_starred);
        editor5.apply();
