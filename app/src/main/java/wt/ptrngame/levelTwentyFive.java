...
public class levelTwentyFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_twenty_five);
    ...
    public void levelWon(){
        ...
        if(level_twentyfive_completed == 0){
            level_twentyfive_completed = 1;
            total_completed += 1;
        }
        else{
            level_twentyfive_completed = 1;
        ...
        if(current_toggles <= toggles_for_star){
            if(level_twentyfive_starred == 0){
                level_twentyfive_starred = 1;
                total_starred += 1;
                if(sounds_toggle == 0){
        ...
        editor.putInt("LevelTwentyfiveCompleted", level_twentyfive_completed);
        editor.putInt("LevelTwentyfiveStarred", level_twentyfive_starred);
        editor.apply();
