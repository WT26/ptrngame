...
public class levelTwentyTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_twenty_two);
    ...
    public void levelWon(){
        ...
        if(level_twentytwo_completed == 0){
            level_twentytwo_completed = 1;
            total_completed += 1;
        }
        else{
            level_twentytwo_completed = 1;
        ...
        if(current_toggles <= toggles_for_star){
            if(level_twentytwo_starred == 0){
                level_twentytwo_starred = 1;
                total_starred += 1;
                if(sounds_toggle == 0){
        ...
        editor.putInt("LevelTwentytwoCompleted", level_twentytwo_completed);
        editor.putInt("LevelTwentytwoStarred", level_twentytwo_starred);
        editor.apply();
