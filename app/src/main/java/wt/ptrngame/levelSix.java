...
public class levelSix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level_six_completed = preferences3.getInt("LevelSixCompleted", 0);
    ...
    public void levelWon(){
        ...
        if(level_six_completed == 0){
            level_six_completed = 1;
            total_completed += 1;
        }
        else{
            level_six_completed = 1;
        ...
        editor5.putInt("LevelSixStarred", level_six_starred);
        editor5.apply();
