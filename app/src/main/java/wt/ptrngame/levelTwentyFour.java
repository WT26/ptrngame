...
public class levelTwentyFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_twenty_four);
    ...
    public void levelWon(){
        ...
        if(level_twentyfour_completed == 0){
            level_twentyfour_completed = 1;
            total_completed += 1;
        }
        else{
            level_twentyfour_completed = 1;
        ...
        if(current_toggles <= toggles_for_star){
            if(level_twentyfour_starred == 0){
                level_twentyfour_starred = 1;
                total_starred += 1;
                if(sounds_toggle == 0){
        ...
        editor.putInt("LevelTwentyfourCompleted", level_twentyfour_completed);
        editor.putInt("LevelTwentyfourStarred", level_twentyfour_starred);
        editor.apply();
