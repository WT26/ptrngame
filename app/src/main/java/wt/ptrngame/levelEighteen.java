...
public class levelEighteen extends AppCompatActivity {
    ...
    public void levelWon(){
        ...
        if(level_eighteen_completed == 0){
            level_eighteen_completed = 1;
            total_completed += 1;
        }
        else{
            level_eighteen_completed = 1;
        ...
        if(current_toggles <= toggles_for_star){
            if(level_eighteen_starred == 0){
                level_eighteen_starred = 1;
                total_starred += 1;
                if(sounds_toggle == 0){
        ...
        editor.putInt("LevelEighteenCompleted", level_eighteen_completed);
        editor.putInt("LevelEighteenStarred", level_eighteen_starred);
        editor.apply();
